def generate_case_get_link_first_entity(links, name_partition_key_field, id_separator):
    mapping = {
...
def generate_case_many_to_one_or_one_to_one_first_entity(link, name_partition_key_field, id_separator):
...
def generate_case_one_to_many_or_one_to_one_second_entity(link, name_partition_key_field, id_separator):
    second_entity = link['second_entity']
    first_entity = link['first_entity']
    return f"""
