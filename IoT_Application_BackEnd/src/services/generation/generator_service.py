...
def generate_code(json: dict) -> dict:
    ...
    __generate_exception(code_generated)
...
def __generate_exception(codes_generated: dict):
    """
...
def __generate_dynamo_manager_resources(codes_generated: dict, json: dict):
    ...
    :param json: the json with the data.
    """
    codes_generated['code_generated/src/dal/dynamo_manager.py'] = generate_dbmanager()
