from services.generation.configuration_application.dal.dynamo_manager.generator_base_aws_service import \
    generate_base_aws_service
from services.generation.configuration_application.dal.dynamo_manager.generator_dynamo_manager import generate_dbmanager
from services.generation.configuration_application.dal.dynamo_manager.project_dynamo_manager.generator_project_dynamo_manager import generate_project_dynamo_manager
from services.generation.configuration_application.dal.event.generator_event_class import generate_event_class
from services.generation.configuration_application.dal.event.generator_event_parse import generate_event_parse
from services.generation.configuration_application.dal.generator_utility import generate_utility
from services.generation.configuration_application.dal.lambda_functions.generate_lambda_entity import \
    generate_lambda_entity
from services.generation.configuration_application.dal.lambda_functions.generate_lambda_link import generate_lambda_link
from services.generation.configuration_application.dal.model.generate_model_entity import generate_model_entity
from services.generation.configuration_application.dal.model.generate_model_link import generate_model_link
from services.generation.configuration_application.dal.response_manager.generator_exception import generate_exception
from services.generation.configuration_application.dal.response_manager.generator_response_manager import \
    generate_response_manager
from services.generation.configuration_application.deployment_guide.generator_deployment_guide import \
...
from services.generation.configuration_application.graphql_resources.schema.generate_schema import \
    generate_graphql_schema
from services.generation.configuration_application.requirements.generator_requirements import generate_requirements
from services.generation.configuration_application.templates.cognito.generator_cognito_template import \
    generate_cognito_template
from services.generation.configuration_application.templates.generator_api_template import generate_api_template
from services.generation.utility_methods import generate_resource_name


def generate_code_configuration_application(code_generated: dict, json: dict) -> dict:
    ...
    code_generated = {f'configuration_application/{key}': value for key, value in code_generated.items()}
...
def __generate_graphql_resources(codes_generated: dict, json: dict):
    ...
    codes_generated['src/graphql/invoker.js'] = generate_invoker()
...
def __generate_entities_model(codes_generated: dict, json: dict):
    ...
    for entity in json['entities']:
        ...
        codes_generated[f'src/model/{entity_name.lower()}.py'] = generate_model_entity(entity_name,
                                                                                       entity['fields'])
...
def __generate_response_manager(codes_generated: dict):
    """
        ...
        :param codes_generated: the code that will be generated.
        """
    codes_generated['src/dal/response_manager/exception_class.py'] = generate_exception()
...
def __generate_dynamo_manager_resources(codes_generated: dict, json: dict):
    ...
    codes_generated['src/dal/dynamo_manager/project_dynamo_manager.py'] = generate_project_dynamo_manager(json)
