...
def generate_case_many_to_one_or_one_to_one_first_entity(link: dict, name_partition_key_field: str, id_separator: str) -> str:
...
def generate_case_one_to_many_or_many_to_many_first_entity(link: dict, name_partition_key_field: str, id_separator: str) -> str:
    second_entity = link['second_entity']
    first_entity = link['first_entity']
    return f"""
                if '{second_entity}' in event_parse.projection:
...
def generate_case_one_to_many_or_one_to_one_second_entity(link: dict, name_partition_key_field: str, id_separator: str) -> str:
    second_entity = link['second_entity']
    first_entity = link['first_entity']
    return f"""
...
def generate_case_many_to_one_or_many_to_many_second_entity(link: dict, name_partition_key_field: str, id_separator: str) -> str:
    second_entity = link['second_entity']
    first_entity = link['first_entity']
    return f"""
                if '{first_entity}' in event_parse.projection:
