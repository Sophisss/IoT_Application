from services.generation.configuration_application.dal_resources.dynamo_manager.project_dynamo_manager.resources.generator_entity_functions import \
    generate_entity_methods
from services.generation.configuration_application.dal_resources.dynamo_manager.project_dynamo_manager.resources.generator_link_functions import \
    generate_link_methods
from services.generation.utility_methods import generate_resource_name


def generate_project_dynamo_manager(json_data: dict) -> str:
    """
