...
def __generate_entity_relation_case_first_entity(entity: dict, links_associated_first_entity: list, pr_key: str, sr_key: str, gsi_index: str,
                                                 separator: str) -> str:
    mapping = {"one-to-many": __generate_relation_one_to_many_or_many_to_many_first_entity,
               "many-to-one": __generate_relation_many_to_one_or_one_to_one_first_entity,
               "many-to-many": __generate_relation_one_to_many_or_many_to_many_first_entity,
               "one-to-one": __generate_relation_many_to_one_or_one_to_one_first_entity}
    return "".join(
        mapping[link["numerosity"]](entity, link, pr_key, sr_key, gsi_index, separator) for link in
        links_associated_first_entity)
...
def __generate_entity_relation_case_second_entity(entity: dict, links_associated_second_entity: list, pr_key: str, sr_key: str, gsi_index: str,
                                                  separator: str) -> str:
    mapping = {"one-to-many": __generate_relation_one_to_many_or_one_to_one_second_entity,
               "many-to-one": __generate_relation_many_to_one_or_many_to_many_second_entity,
               "many-to-many": __generate_relation_many_to_one_or_many_to_many_second_entity,
               "one-to-one": __generate_relation_one_to_many_or_one_to_one_second_entity}
    return "".join(
        mapping[link["numerosity"]](entity, link, pr_key, sr_key, gsi_index, separator) for link in
        links_associated_second_entity)
