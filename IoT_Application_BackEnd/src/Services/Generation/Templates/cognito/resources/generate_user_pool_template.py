...
def generate_user_pool_properties(json: dict) -> str:
    """
...
def generate_user_pool_policies(json: dict) -> str:
    """
    ...
    """
    return f"""
        PasswordPolicy: {generate_user_pool_password_policy(json["PasswordPolicy"])}"""


def generate_user_pool_password_policy(json: dict) -> str:
    """
